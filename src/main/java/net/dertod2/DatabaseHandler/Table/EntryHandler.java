...
public abstract class EntryHandler {
     ...
     */
    public abstract void insert(TableEntry tableEntry)
            throws IllegalArgumentException, IllegalAccessException, SQLException;

    public abstract void insert(List<TableEntry> entryList)
            throws IllegalArgumentException, IllegalAccessException, SQLException;

    /**
     * Removes the entry with the similiar primary key in the database<br />
     * <b>WARNING</b>: When no primary Key set and not loaded out of database this
     * method will fail
     * 
     * @param tableEntry
     * @throws SQLException
    ...
    public void remove(TableEntry tableEntry) throws IllegalArgumentException, IllegalAccessException, SQLException {
        if (!tableEntry.isLoadedEntry || !tableEntry.hasPrimaryKey())
            return;
        this.remove(tableEntry,
                ImmutableMap.<String, Object>builder()
                        .put(tableEntry.getPrimaryKey().columnName(), tableEntry.getColumn(tableEntry.getPrimaryKey()))
                        .build());
    }

    /**
     * Removes all entrys out of the database table which matches the
     * filterList<br />
     * <b>WARNING</b>:When the filterList is empty or NULL ALL entrys in the table
     * will be removed
     * 
     * @param tableEntry
     * @param filterList
     ...
     * 
     * @param tableEntry
     * @return true when an entry was updated or false when not loaded entrySet or
     *         no row was updated
     * @throws IllegalAccessException
     * @throws IllegalArgumentException
     * @throws SQLException
    ...
    /**
     * Updates all entries matches the filterList or all entries when the filterList
     * is empty or NULL
     * 
     * @param tableEntry
     * @param filterList
     * @return true when at least one row was updated or false when no row was
     *         updated or the tableEntry is not loaded out of the database
     * @throws SQLException
     * @throws IllegalAccessException
     * @throws IllegalArgumentException
     */
    public boolean update(TableEntry tableEntry, Map<String, Object> filterList)
     ...
     * Updates all entries matches the filterList or all entries when the filterList
     * is empty or NULL<br />
     * Only changes the rows specified with specificRows and ignores all other
     * rows<br />
     ...
     * @throws SQLException
     */
    public abstract boolean update(TableEntry tableEntry, Map<String, Object> filterList, List<String> specificRows)
            throws SQLException, IllegalArgumentException, IllegalAccessException;
     ...
     * @throws Exception
     */
    public abstract boolean update(TableEntry tableEntry, Map<String, Object> filterList,
            Map<String, Object> specificRows) throws Exception;
     ...
     * @throws IllegalArgumentException
     */
    public boolean load(TableEntry tableEntry, Map<String, Object> filterList)
            throws SQLException, IllegalArgumentException, IllegalAccessException {
        return this.load(tableEntry, filterList, null);
    }

    public abstract boolean load(TableEntry tableEntry, Map<String, Object> filterList, LoadHelper loadHelper)
            throws SQLException, IllegalArgumentException, IllegalAccessException;

    public void load(TableEntry tableEntry, List<TableEntry> resultList)
            throws IllegalArgumentException, IllegalAccessException, SQLException {
        this.load(tableEntry, resultList, null, new LoadHelper());
    }

    public void load(TableEntry tableEntry, List<TableEntry> resultList, LoadHelper loadHelper)
            throws IllegalArgumentException, IllegalAccessException, SQLException {
    ...
    public abstract void load(TableEntry tableEntry, List<TableEntry> resultList, Map<String, Object> filterList,
            LoadHelper loadHelper) throws IllegalArgumentException, IllegalAccessException, SQLException;

    protected abstract PreparedStatement prepareSelect(Connection connection, TableEntry tableEntry,
     ...
     * @throws IllegalArgumentException
     */
    public abstract boolean exist(TableEntry tableEntry)
            throws SQLException, IllegalArgumentException, IllegalAccessException;
    ...
    protected void setStatement(int index, PreparedStatement preparedStatement, Object value, Column column)
            throws SQLException {
    ...
    protected String setList(List<?> list) {
        ...
        if (stringBuilder.length() > 0)
            stringBuilder.deleteCharAt(stringBuilder.length() - this.LIST_REGEX.length());
    ...
    protected String setMap(Map<?, ?> map) {
        ...
        for (Entry<?, ?> entry : map.entrySet()) {
            stringBuilder
                    .append((entry.getKey() instanceof Location ? ConverterUtils.toString((Location) entry.getKey())
                            : String.valueOf(entry.getKey()))
                            + this.LIST_REGEX
                            + (entry.getValue() instanceof Location
                                    ? ConverterUtils.toString((Location) entry.getValue())
        ...
        if (stringBuilder.length() > 0)
            stringBuilder.deleteCharAt(stringBuilder.length() - this.MAP_REGEX.length());
