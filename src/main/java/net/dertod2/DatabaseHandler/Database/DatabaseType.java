...
public enum DatabaseType {
	...
	private DatabaseType(String driverPackage, boolean usesDatabaseDriver, boolean supportConnectionPool, Class<? extends AbstractDatabase> driverClass, Integer defaultPort) {
